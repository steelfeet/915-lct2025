...
for class_n in tqdm(os.listdir(CLASSES_DIR)):
    ...
    for filename in os.listdir(class_dir):
        ...
        ver, lat, long, dir = filename.split("-")
        print(f"{lat},{long}")
        data = safe_request.get_url_html(f"https://geocode-maps.yandex.ru/v1/?apikey=ebdbf838-c3ec-456e-a490-05e34463788e&geocode={long},{lat}&format=json")
        print(data)
        exit()
