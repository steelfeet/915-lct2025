...
model, processor = FastModel.from_pretrained(
    model_name = "unsloth/gemma-3n-E12B-it", # Or "unsloth/gemma-3n-E2B-it"
...
model.save_pretrained(os.path.join(cache_dir, "gemma3n_ru_1"))  # Local saving
processor.save_pretrained(os.path.join(cache_dir, "gemma3n_ru_1"))
